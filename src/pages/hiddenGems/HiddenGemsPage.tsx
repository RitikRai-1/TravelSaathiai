...
export const HiddenGemsPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-emerald-700 via-teal-700 to-slate-900 rounded-3xl p-5 sm:p-8 md:p-12 text-white shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6">
        <div className="space-y-3 max-w-xl">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold font-heading">Secret & Undiscovered Gems of India</h1>
        ...
        <Link
          to="/plan-trip"
          className="px-6 py-3.5 bg-[#F9C74F] hover:bg-amber-400 text-slate-950 font-bold text-sm rounded-2xl shadow-lg transition flex items-center space-x-2 shrink-0 self-start md:self-auto min-h-[44px]"
        >
      ...
      <div className="flex items-center space-x-2 overflow-x-auto pb-2 scrollbar-none">
        {categories.map((cat) => (
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition cursor-pointer min-h-[44px] ${
            ...
            >
                ...
                <div className="p-4 sm:p-6 space-y-4">
                  ...
                  <div className="p-3.5 bg-emerald-50/60 rounded-2xl border border-emerald-100 text-xs space-y-1.5 text-slate-700">
                    <div className="flex justify-between gap-2">
                      <span className="text-emerald-800 font-semibold shrink-0">How to Reach:</span>
                      <span className="text-slate-600 font-medium text-right">{gem.route_info}</span>
                    </div>
              ...
              <div className="p-4 sm:p-6 pt-0 space-y-2">
                <Link
                  ...
                  className="w-full py-2.5 bg-[#1B5E20] hover:bg-[#154a19] text-white rounded-xl text-center text-xs font-bold transition flex items-center justify-center space-x-1.5 shadow-xs min-h-[44px]"
                >
                ...
                <div className="grid grid-cols-3 gap-1.5 pt-1">
                  <Link
                    ...
                    className="p-1.5 rounded-lg bg-slate-100 hover:bg-emerald-50 text-slate-700 hover:text-[#1B5E20] text-[10px] font-semibold flex items-center justify-center space-x-1 transition text-center min-h-[44px]"
                    title="Nearby Stays"
                  >
